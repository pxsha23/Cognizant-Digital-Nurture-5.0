# Git Hands-On — Command Guide (Git-HOL 1–5)

Run these in Git Bash. Screenshot the marked (📸) outputs — those are your proof.

---

## Lab 1: Git Config, Notepad++ Integration, First Commit (~30 min)
...
## Notes
- These labs assume a GitLab account + P4Merge already installed, per the docs' prerequisites.
  If you don't have P4Merge set up, tell me and I'll walk through installing/configuring it as
  a Git diff/merge tool.
- Every 📸 marker is a required proof screenshot per the original lab instructions.
- If any command errors out, paste the exact error here before moving to the next step.
